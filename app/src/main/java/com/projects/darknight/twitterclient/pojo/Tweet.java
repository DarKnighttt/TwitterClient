...
public class Tweet {
    ...
    public Tweet(User user, Long id, String creationDate, String text, Long retweetCount, Long likesCount, String imageUrl) {
        this.user = user;
        this.id = id;
    ...
    public boolean equals(Object o) {
        ...
        if (!likesCount.equals(tweet.likesCount)) return false;
